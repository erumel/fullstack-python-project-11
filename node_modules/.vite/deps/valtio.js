...
import { a as subscribe, c as unstable_replaceInternalFunction, d as isChanged, i as snapshot, l as affectedToPathList, n as proxy, o as unstable_enableOp, r as ref, s as unstable_getInternalStates, t as getVersion, u as createProxy } from "./vanilla-D34PNEkk.js";
...
//#endregion
//#region node_modules/valtio/esm/react.mjs
...
function useSnapshot(proxyObject, options) {
	...
	const affected = (0, import_react.useMemo)(() => proxyObject && /* @__PURE__ */ new WeakMap(), [proxyObject]);
	const lastSnapshot = (0, import_react.useRef)(void 0);
	let inRender = true;
	const currSnapshot = (0, import_react.useSyncExternalStore)((0, import_react.useCallback)((callback) => {
		...
		try {
			if (!inRender && lastSnapshot.current && !isChanged(lastSnapshot.current, nextSnapshot, affected, /* @__PURE__ */ new WeakMap())) return lastSnapshot.current;
		} catch (e) {}
		return nextSnapshot;
	...
	if ((import.meta.env ? import.meta.env.MODE : void 0) !== "production") condUseAffectedDebugValue(currSnapshot, affected);
	return createProxy(currSnapshot, affected, (0, import_react.useMemo)(() => /* @__PURE__ */ new WeakMap(), []), targetCache);
}
//#endregion
export { getVersion, proxy, ref, snapshot, subscribe, unstable_enableOp, unstable_getInternalStates, unstable_replaceInternalFunction, useSnapshot };
